...
export default function App() {
  ...
  return <div className="App">{user ? (docs&&docs.docs[0].metadata._document.data.value.mapValue.fields.position.stringValue==="employee"? <div>hello</div>:<Home />) : <ButtonAppBar />}</div>;
}
